...
const STATIC_EDGES = [
  ...
  { from: "toolspanel",    to: "bulkinitiative" },
...
const KNOWN_NODES = {
  ...
  "bulkinitiative":  { label: "BulkSetInitiative.jsx",  sub: "Bulk set initiative",    description: "Discovers the initiative multi-select field dynamically from get_case_fields, renders the same collapsible tree, skips already-set and template-mismatch cases, and rate-limits to 5 updates per batch with 500ms spacing.",                      x: 220,  y: 800, color: "#f97316", group: "tool"          },

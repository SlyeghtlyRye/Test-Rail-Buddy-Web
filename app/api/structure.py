...
KNOWN = {
    ...
    "BulkSetInitiative.jsx": "Bulk-assigns a multi-select initiative field across selected cases. Discovers the initiative field dynamically from get_case_fields, skips already-set and template-mismatch cases, and rate-limits updates to 5 per batch with 500ms spacing.",
